...
void initBindings(pybind11::module_& m)
{
    m.def("attention", &torch_ext::attention,
        ...
        py::arg("update_kv_cache"), py::arg("attention_config_params"), py::arg("tokens_per_block") = std::nullopt,
        ...
        py::arg("spec_decoding_tensor_params"), py::arg("sparse_batch_offsets") = std::nullopt,
        py::arg("all_sparse_indices") = std::nullopt, "Multi-head attention operation",
